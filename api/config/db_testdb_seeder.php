...
// drop old database
$dropSql = "DROP DATABASE IF EXISTS TEST_movie_database";
...
// create database
$createSql = "CREATE DATABASE TEST_movie_database";
...
// Parse .csv file
$handle = fopen("api/config/sample_csvs/TEST-Movie-List.csv", "r");
if ($handle) { 
